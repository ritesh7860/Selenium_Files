...
public class FristPlayWriteClass 
{
...
//		System.out.println(page.url());
		...
		page.locator("//input[@placeholder='Patient Name']").fill("Nisha Singh");
		Thread.sleep(2000);
//		page.keyboard().press("Backspace");		
		...
		page.keyboard().press("Enter");
		page.locator("//*[@id='rc_select_3']").fill("Aadhar");
		page.keyboard().press("Enter");
		Thread.sleep(2000);
		...
		page.keyboard().press("Enter");
		System.out.println(page.url());
		page.locator("//input[@name='contact_number']").fill("98064759196");
		Thread.sleep(2000);
		page.keyboard().press("Backspace");
		Thread.sleep(2000);
		page.locator("//input[@placeholder='Email Id']").fill("nisha@mightcode.com");
		...
		page.locator("//input[@name='identity_card']").fill("365201563233");
		
		page.locator("//input[@placeholder='Contact Person Name']").fill("Deepali Singh");
		page.locator("//*[@id='rc_select_6']").fill("Other Relative/ Friend/ Neighbour");
		page.keyboard().press("Enter");
		
		page.locator("//input[@name='relative_contact_number']").fill("7398848456");
		Thread.sleep(2000);
